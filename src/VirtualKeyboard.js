...
const VERY_BIG_SYMBOLS = ["\\sum","\\prod","\\int","\\iint","\\iiint","\\oint","\\dv","\\pdv","dvn","pdvn","\\bigcup","\\bigcap","\\bigoplus","\\bigotimes","\\overbrace","\\underbrace","\\bigwedge","\\bigvee","\\bigodot","\\biguplus","\\iiiint","\\idotsint","pdvmixed","\\fdv","\\braket","\\ketbra","\\mel**","\\eval","\\xrightarrow","\\xleftarrow","\\binom","\\overunderset"];
...
const VirtualKeyboard = ({ formulaEditorRef }) => {
  return (
    ...
    <div className="virtual-keyboard">
      ...
      <Category title="Other delimiters & constructs" symbols={CONSTRUCTS} reference={formulaEditorRef} nKeysShown={15} keyClassName="larger-button"/>
