...
const CONSTRUCTS = ["\\lvert","\\lVert","\\lfloor","\\lceil","\\langle","\\sum","\\prod","\\int","\\dv","\\pdv","\\bigcup","\\bigcap","\\bigoplus","\\bigotimes","\\widehat","\\overrightarrow","\\ket","\\bra","\\braket","\\ketbra","\\mel**","\\overbrace","\\underbrace","\\bigwedge","\\bigvee","\\bigodot","\\biguplus","\\iint","\\iiint","\\oint","\\iiiint","\\idotsint","\\widetilde","\\overleftarrow","\\overline","\\underline","\\overleftrightarrow","\\underleftrightarrow","\\underleftarrow","\\underrightarrow","\\ulcorner","\\llcorner","\\overset","\\underset","inverse","transpose","updagger","\\eval","pdvmixed","\\fdv","dvn","pdvn","\\stackrel{!}","\\stackrel{?}"];
...
const VERY_BIG_SYMBOLS = ["\\sum","\\prod","\\int","\\iint","\\iiint","\\oint","\\dv","\\pdv","dvn","pdvn","\\bigcup","\\bigcap","\\bigoplus","\\bigotimes","\\overbrace","\\underbrace","\\bigwedge","\\bigvee","\\bigodot","\\biguplus","\\iiiint","\\idotsint","pdvmixed","\\fdv","\\braket","\\ketbra","\\mel**","\\eval"];
...
const FirstRow = ({reference}) => {
  ...
  return (
    <div className="first-row">
      ...
      <h3>Styles</h3>
      <div className="key-row">
        {["\\mathbf","\\mathcal","\\mathbb","\\mathfrak","\\mathsf"].map((symbol)=> (
