...
const CONSTRUCTS = ["\\sum","\\prod","\\int","\\iint","\\iiint","\\oint","\\bigcup","\\bigcap","\\bigoplus","\\bigotimes","\\overbrace","\\underbrace","\\widehat","\\overrightarrow","\\ket","\\bra","\\bigwedge","\\bigvee","\\bigodot","\\biguplus","\\iiiint","\\idotsint","\\widetilde","\\overleftarrow","\\overline","\\underline"];
...
const VirtualKeyboard = ({ formulaEditorRef }) => {
  ...
  return (
    ...
    <div className="virtual-keyboard">
      ...
      <Category title="Binary 'ordering' relations" symbols={ORDER} getShortcut={getShortcut} reference={formulaEditorRef}/>
